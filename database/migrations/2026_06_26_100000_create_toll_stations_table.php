...
return new class extends Migration
{
    ...
    {
        // 1. Create sequence for station_id auto-increment
        DB::unprepared("
        ...
        // 2. Create the toll_stations table
        DB::unprepared("
        ...
        // 3. Insert Sample Data — 8 Realistic Bangladeshi Toll Stations
        // Using Admin user_id = 4 which exists in the database
        DB::insert("
    ...
    {
        DB::unprepared("DROP TABLE toll_stations");
        DB::unprepared("DROP SEQUENCE station_id_seq");
    }
};
